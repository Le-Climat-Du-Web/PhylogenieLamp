...
def clustal_alignment(infile, outfile):
    ...
    clustal_exe = "/var/www/html/Phylogenie/static/tools/Linux/clustalo-1.2.4-Ubuntu-x86_64"
...
def muscle_alignment(infile, outfile):
    ...
    muscle_exe = "/var/www/html/Phylogenie/static/tools/Linux/muscle3.8.31_i86linux64"
...
def ML_tree(infile, outfile, file_type):
    ...
    cmd = PhymlCommandline("/var/www/html/Phylogenie/static/tools/Linux/PhyML-3.1/PhyML-3.1_linux64",
...
dirName=""
saveDir = "/var/www/html/Phylogenie/static/data/sauvegardes/"
